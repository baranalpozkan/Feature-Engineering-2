...
# Partner : Müşterinin bir eşi olup olmadığı (Evet, Hayır) ? Evli olup olmama
...
# Accuracy: 0.78
# Recall: 0.633 # pozitif sınıfın ne kadar başarılı tahmin edildiği
# Precision: 0.49 # Pozitif sınıf olarak tahmin edilen değerlerin başarısı
# F1: 0.55
# Auc: 0.73
...
df.loc[(df["tenure"] >= 50) & (df["tenure"] <= 72), "NEW_TENURE_YEAR"] = "5-6 Year"
...
df["NEW_FLAG_ANY_STREAMING"] = df.apply(lambda x: 1 if (x["StreamingTV"] == "Yes") or (x["StreamingMovies"] == 0) else 0, axis=1)
...
# Baz Model
# Accuracy: 0.78
# Recall: 0.667 # pozitif sınıfın ne kadar başarılı tahmin edildiği
# Precision: 0.5 # Pozitif sınıf olarak tahmin edilen değerlerin başarısı
# F1: 0.57
# Auc: 0.75
